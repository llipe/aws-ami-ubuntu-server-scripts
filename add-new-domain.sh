...
sudo mkdir -p /home/$DOMAIN/public
sudo mkdir -p /home/$DOMAIN/log

# Set permissions
sudo chown -R www-data:www-data /home/$DOMAIN/public
sudo chown -R www-data:www-data /home/$DOMAIN/log
